...
from tcp import TCP # Call Local TCP implementation
...
class Main(object):
	...
	parser.add_option("-w","--window",type="int",dest="window_size",
			default=3000,
			help="buffer window size")
    ...
    def run(self):
        ...
        # setup connection
        c1 = TCP(t1,n1.get_address('n2'),1,n2.get_address('n1'),1,a,window=self.window_size)
        c2 = TCP(t2,n2.get_address('n1'),1,n1.get_address('n2'),1,a,window=self.window_size)
