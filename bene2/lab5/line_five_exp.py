...
class Main(object):
	...
	def parse_options(self):
		...
		parser.add_option("-r", "--runtime", type="int", dest="runtime", default=10)
	...
	def run(self):
		...
		# setup network
		net = Network('networks/five-line.txt')
		...
		p1 = packet.Packet(source_address=n1.get_address('n2'), destination_address=\
			n5.get_address('n4'), ttl=100, protocol='senddata', body=body)
		...
		Sim.scheduler.add(delay=6, event=p3, handler=n5.send_packet)
